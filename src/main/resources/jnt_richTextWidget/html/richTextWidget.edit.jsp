...
<ui:ckeditor selector="inputtext-${currentNode.UUID}"/>
    ...
    <div class="box-1">
        <template:tokenizedForm>
            <form action="<c:url value="${url.base}${currentNode.path}"/>" method="POST" class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="inputtext-${currentNode.UUID}" class="col-lg-2 control-label"><fmt:message key="jnt_bigText.text"/></label>
                    <div class="col-lg-10">
                        <textarea type="text" name="text" class="form-control jahia-ckeditor" id="inputtext-${currentNode.UUID}" rows="8"><c:out value="${currentNode.properties['text'].string}"/></textarea>
                    </div>
                </div>
